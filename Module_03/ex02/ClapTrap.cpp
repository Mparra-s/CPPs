...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/26 14:51:03 by mparra-s          #+#    #+#             */
/*   Updated: 2026/01/07 12:12:10 by mparra-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string &string){
    ...
    if(this->energy_points <= 0 && this->hit_points > 0)
        std::cout << this->type << " " << this->name << " doesn't have energy points and can't attack" << std::endl;
...
void ClapTrap::beRepaired(unsigned int amount){
    if(this->hit_points == this->max_hit_p && this->energy_points > 0)
        std::cout << this->type << " " << this->name << " doesn't need restore " << amount << " hit points because it's at maximum" << std::endl; 
